            ...
            <div class="row w-100">
                ...
                <div class="col-md-8">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 justify-content-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Register Authority Users</a>
                        </li>
                        <li class="nav-item">
...
<div class="container">
    ...
    <div class="col-sm-4 mb-3 mb-sm-0 pt-4">
                <div class="card">
                    <div class="card-body text-center">
                        <!-- Circular Image -->
                        <img src="../../assets/images/user1.png" style="background-color: grey;" alt="Card Image" class="rounded-circle mb-3" width="100px" height="100px">
                        <h5 class="card-title">Register Authority Users</h5>
